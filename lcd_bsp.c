...
#else
// ------------------------------------
// DUMMY DRIVER FOR STANDARD ESP32 (Non-S3)
// ------------------------------------
#include "esp_log.h"
#include "driver/gpio.h"

// Minimal LVGL init to process Logic/Callbacks but without screen output
...
// Touch init dummy - REMOVED to avoid conflict with cst816.cpp
// void Touch_Init(){
